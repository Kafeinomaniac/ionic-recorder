// Copied from:
// github.com/basarat/typescript-collections/blob/release/src/lib/Dictionary.ts
// slightly modified.
...
export class Dictionary<K, V>{
    ...
    // [key: K] will not work since indices can only by strings in
    // javascript and typescript enforces this.
     ...
     * objects as keys.</p>
     *
     * <p>If the keys are custom objects a function which converts
     * keys to unique strings must be provided. Example:</p>
     * <pre>
