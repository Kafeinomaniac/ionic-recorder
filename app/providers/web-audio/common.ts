...
// export function mediaRecorderTypesSupported(): string[] {
//     'use strict';

//     // if (!MediaRecorder || MediaSource.isTypeSupported === undefined) {
//     //     return [];
//     // }
...
//     for (i = 0; i < len; i++) {
//         type = types[i];
//         if ('MediaSource' in window && MediaSource.isTypeSupported(type)) {
